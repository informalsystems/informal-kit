...
export function AnimatedOverlay({
  ...
  const [isDescendedFromDarkElement, setIsDescendedFromDarkElement] =
    useState(false)
  ...
  // const perimeter = widthWithPadding * 2 + heightWithPadding * 2
    ...
    <div
      className={twMerge(
        `
          ...
          duration-700
        `,
        isDescendedFromDarkElement && 'dark',
        className,
      )}
      style={{
